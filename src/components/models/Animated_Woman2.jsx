...
Command: npx gltfjsx@6.2.13 .\\public\\models\\Animated_Woman2.glb 
*/
...
export function AnimatedWoman2(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(
    "/models/Animated_Woman2.glb"
  );
...
useGLTF.preload("/models/Animated_Woman2.glb");
